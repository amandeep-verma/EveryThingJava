...
public class _03_main {
	public static void main(String[] args) {
		...
		// Integer class has inbuild method sum
		Integer res2 = values.stream().map(i -> i * 2).reduce(0,(c, e) -> Integer.sum(c, e));
		
		// Using Method reference 
		Integer res3 = values.stream().map(i -> i * 2).reduce(0,Integer::sum);

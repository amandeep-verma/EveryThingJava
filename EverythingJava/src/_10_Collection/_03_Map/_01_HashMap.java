...
public class _01_HashMap {
	...
	public static void main(String[] args) {
		...
		// Supports multithreading but is not synchronized, which is to say if multiple threads access it we must
		...
		// putting the new value with same key again will removes the previous key-value pair and add the new one
		...
		// Sorting the hashmap
		// Since hashmap doesn't follows insertion order, you can't sort the elements within map
		
		//1. You can store keys in a set and sort the set, Now you can fetch the values using iterator in sorted fashion
		...
		// Since our list stores both keys and values we can perform custom sorting using both or either.
		li.sort((o1,o2)->{

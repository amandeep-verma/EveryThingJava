...
public class _02_ListProject {
	...
	public static void main(String[] args) {
		...
		// Since list is the interface extended from collection interface it has all the
		...
		co.set(0, "tea"); // set function replaces an entry
		...
		// listIterator has more methods specific to List only. It has more methods.
		// Both are used similary though
		...
		// sort takes Comparator object, specifying it null makes it to order in natural
		// ordering of element.
